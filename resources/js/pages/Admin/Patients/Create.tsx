...
export default function Create() {
    ...
    return (
        <AdminLayout breadcrumbs={[{ title: 'Patients', href: '/admin/patients' }, { title: 'Create', href: '/admin/patients/create' }]}>
                    ...
                    <CardContent>
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div className="flex justify-end gap-2 mt-4">
                                ...
                                <Button type="submit" disabled={processing}>Save Patient</Button>
                            </div>
                        </form>
                    </CardContent>
                </Card>
